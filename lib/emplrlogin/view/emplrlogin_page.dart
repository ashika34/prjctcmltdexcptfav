        ...
        child: Column(
          children: [
            ...
            Image.asset('assets/images/careerpoint.png',
                ...
                Column(
                  children: [
                    Text('Empower Your Hiring Journey',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 19 ),),
                    SizedBox(
                      height: 10
                      ),
                      Text('Log in to find the perfect candidates for your team.',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                  ],
